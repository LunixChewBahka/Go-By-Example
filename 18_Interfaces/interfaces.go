...
// implement and interface on rect and circle types
type rect struct {
...
// The actual implementation for circles with area and perims
...
named interface. Here's a generic measure function taking advantage of this work
on any geometry
