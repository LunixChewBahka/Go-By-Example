...
func main() {
	...
	fmt.Println("[1] Addr: %v Value1: %d Value2: %s\n",
		pointer,
		myValue.Value1,
		myValue.Value2)
	...
	// Display the address and values
	fmt.Println("[3] Addr: %v Value1: %d Value2: %s\n",
		pointer,
		myValue.Value1,
		myValue.Value2)
}
...
func ChangeMyValue(myValue *MyType) {
	...
	// Crate a pointer to the memory for myValue
	pointer := unsafe.Pointer(myValue)

	// Display the address and values
	fmt.Println("[2] Addr: %v Value1: %d Value2: %s\n",
		pointer,
		myValue.Value1,
		myValue.Value2)
}
